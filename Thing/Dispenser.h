...
class CDispenser : public CThing
   ...
   public:
      ...
      struct LogicInfo {
         char const * pszName;               // Name of logic (for list box).
         char const * apszParms[NumParms];   // Parm descriptions or nullptr for none.
         char const * pszDescription;     // Description of logic (for text box).
      };
