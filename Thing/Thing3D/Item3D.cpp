...
char const * CItem3d::ms_apszKnownAnimBaseNames[CItem3d::NumTypes]   =
   {
   "None",           // None.
   "Custom",         // Custom.
   "3d/Trumpet",     // Trumpet.
...
char const * CItem3d::ms_apszKnownAnimDescriptions[CItem3d::NumTypes]   =
   {
   "None",
   "Custom",
   "Trumpet",
...
static char const * ms_apszResExtensions[NUM_RES_NAMES]  =
   {
   "sop",
   "mesh",
   "tex",
