...
class CDude : public CCharacter
   ...
   public:
      ...
      struct WeaponDetails {
         char const * pszWeaponName;
         char const * pszAmmoName;
         char const * pszStatusFormat;
         char const * pszWeaponResName;
         int16_t sMinAmmoRequired;
      };

      // This special version overrides the CAnim3D Get(char const * , char const * , int16_t).
