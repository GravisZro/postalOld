...
//                   object.
//
//    06/04/97 JMI   Now aborts ms_pBandSongSound, if not nullptr, in destructor.
...
//
//    06/17/97 JMI   Added nullptr in call to PlaySample() corresponding to new
//                   param.
//
...
static char const * ms_apszStandResNames[] =
{
   "3d/bandg_stand.sop",
   "3d/bandg_stand.mesh",
   "3d/bandg_stand.tex",
...
// An array of pointers to resource names (one for each channel of the animation)
static char const * ms_apszRunResNames[] =
{
   "3d/bandg_run.sop",
   "3d/bandg_run.mesh",
   "3d/bandg_run.tex",
...
// An array of pointers to resource names (one for each channel of the animation)
static char const * ms_apszMarchResNames[] =
{
   "3d/bandg_march.sop",
   "3d/bandg_march.mesh",
   "3d/bandg_march.tex",
...
// An array of pointers to resource names (one for each channel of the animation)
static char const * ms_apszShotResNames[] =
{
   "3d/bandg_shot.sop",
   "3d/bandg_shot.mesh",
   "3d/bandg_shot.tex",
...
// An array of pointers to resource names (one for each channel of the animation)
static char const * ms_apszBlownupResNames[] =
{
...
// An array of pointers to resource names (one for each channel of the animation)
static char const * ms_apszOnFireResNames[] =
{
   "3d/bandg_onfire.sop",
