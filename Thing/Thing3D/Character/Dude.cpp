...
//                   weapon or nullptr.  The return value should not be compared to
...
//
//             JMI   Added nullptr in call to PlaySample() corresponding to new
//                   param.
//
...
//                   nullptr we'd be fucked AND m_ptransRigid was not the
...
//
//    08/10/97 JMI   Changed doubles dDistX and Z to int16_ts sDistX and Z.  The
//                   compiler seemed to lock up when inlining was enabled and we
//                   passed these two doubles to rspATan.  With a different
//                   function it worked fine and with one of the vars as a int16_t
...
#include "Dude.h"
#include <Thing/Weapon/Grenade.h>
#include <Game.h>
#include <SampleMaster.h>
#include <Input.h>
#include <Thing/AnimatedThing.h>
#include <Reality.h>
...
// Handy macro to define char const * array with one 'base' name.
...
int16_t CDude::CDudeAnim3D::Get(   // Returns 0 on success.
   char const * pszBaseFileName, // In:  Base string for resource filenames.
   char const * pszRigidName,    // In:  String to add for rigid transform channel
                                 // or nullptr for none.
   char const * pszEventName,    // In:  String to add for event states channel
                                 // or nullptr for none.
