...
class CDoofus : public CCharacter
   ...
   //---------------------------------------------------------------------------
   public:
         enum Action {                 // Suggested logic actions basec on evaluation of situation
   ...
   public:
      static char const * ms_apszActionNames[];// Names of the logic actions
