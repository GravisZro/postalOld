...
//                   shadow sprite's image to make sure it is nullptr before
...
class CThing3d : public CThing
   ...
   public:
      ...
      static char const * ms_apszStateNames[];     // Strings describing states, indexed by
                                             // the state enum.
...
//#endif
      ...
      CAnimThing* StartAnim(              // Returns ptr to CAnimThing on success; nullptr otherwise.
         char const * pszAnimResName,     // In:  Animation's resource name.
