...
//                   sound schemes are int16_t on some sounds like the female
...
//                   I made the names nullptr so that all of the animations
...
Personatorium const g_apersons[Personatorium::NumPersons] =
   {
