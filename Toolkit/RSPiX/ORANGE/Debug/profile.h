...
class	RProfile
	{
public:
	void	StartProfile(char const *  pszFieldName);
	void	EndProfile(char const *  pszFieldName);
	//----------------------------
	void	SetOutput(char const * pszOutput)
		{
...
inline void rspProfileOptimizeOut(char const *  a) { (void)a; } // used to trick the compiler
