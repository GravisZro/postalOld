...
int16_t CFlx::WritePixelDelta(FLX_BUF* pbufNext, FLX_BUF* pbufPrev, uint8_t* pBuf, long* plChunkSize)
{
	...
	*plChunkSize = 0;
	...
	int32_t lSize = (int32_t)m_filehdr.sWidth * (int32_t)m_filehdr.sHeight;
...
#if 0
	int32_t lSize = CompressBRUN(pbufNext->pbPixels, pbufNext->sPitch,
...
//
///////////////////////////////////////////////////////////////////////////////
int16_t CFlx::WriteDataChunk(uint8_t* pbData, int32_t lSize, uint16_t wType, long* plChunkSize)
	{
	FLX_DATA_HDR datahdr;
...
int16_t CFlx::AllocBuf(FLX_BUF* pbuf, int16_t sWidth, int16_t sHeight, int16_t sColors)
	...
	if ((pbuf->pbPixels) && (pbuf->prgbColors))
		return 0;
