...
//							since SetParent(nullptr) does such.
//
...
//							Also, ~RGuiItem() calls Destroy() after SetParent(nullptr).
//
...
#define SET(pval, val)					((pval) ? *pval = val : val)
...
RGuiItem*	RGuiItem::ms_pguiFocus	= nullptr;	// Higher level APIs can use this
															...
															// input focus.
char const *			RGuiItem::ms_apszTypes[NumGuiTypes]	=	// Array of strings 
																	// indexed by type.
	{
	"GuiItem",
	"Txt",
...
RGuiItem* RGuiItem::SetFocus(		// Returns pointer to GUI losing the focus.
	...
	if (pguiNewFocus != ms_pguiFocus)
		...
		if (ms_pguiFocus == pguiNewFocus && pguiNewFocus)
			{
			// Let the gainer know.
...
//////////////////////////////////////////////////////////////////////////////
// static 
RGuiItem* RGuiItem::FocusNext(void)		// Returns new item with focus or nullptr,
													// if none.
	{
...
//////////////////////////////////////////////////////////////////////////////
// static 
RGuiItem* RGuiItem::FocusPrev(void)		// Returns new item with focus or nullptr,
													// if none.
	{
	// If there is a current . . .
	if (ms_pguiFocus)
