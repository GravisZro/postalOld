...
RListBox::RListBox()
	...
	m_sbVert.m_ulUserInstance	= this;
	...
	m_sbHorz.m_ulUserInstance	= this;
...
RGuiItem* RListBox::AddString(		// Returns new GUI item on success.
	char const * pszString,						// String to add.
...
RGuiItem* RListBox::InsertString(	// Returns new GUI item on success.
	char const * pszString,						// String to insert.
...
RGuiItem* RListBox::CreateStringItem(	// Returns new item on success;
													// nullptr, otherwise.
	char const * pszString)							// Text for new item.
	{
