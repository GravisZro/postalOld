...
//
//		03/13/97	JMI	Added SetText(int32_t lId, char const * pszFrmt, ...);
//							Added GetVal(int32_t lId) and GetText(int32_t lId, char const *);
//
...
//
//		06/08/97 MJR	Removed tests for nullptr pointers from Destroy().  This
...
#define RSP_SAFE_GUI_REF_IF(pgui, ref)			if(pgui) { (pgui)->ref; }
...
//////////////////////////////////////////////////////////////////////////////
	...
	public:	// Typedefs/Enums.
		enum Justification {		// Values for member flags.
		...
		enum Type {	// This type's value indicates a RGuiItem's or descendant's
							// type.
	...
	public:	// Methods.
		...
		void SetText(	
			char const * pszFrmt,	// sprintf formatted format string.
		...
		// See LoadInstance(char const *).
		int16_t Load(					// Returns 0 on success.
			char const * pszFileName);	// Name of file to load from.
		...
		int16_t Save(					// Returns 0 on success.
			char const * pszFileName);	// Name of file to save to.
...
//////////////////////////////////////////////////////////////////////////////
	...
	public:	// Static
		...
		static RGuiItem* LoadInstantiate(	// Returns newly allocated GUI item
			...
			char const *	pszFileName);					// Name of file to instantiate from.
	...
	public:	
      ...
      int32_t GetVal(		// Returns value.
		...
		RGuiItem* GetItemFromId(	// Returns pointer to RGuiItem, if found;
         ...
         Variant lId)					// ID of RGuiItem to find.
			{
			RGuiItem*	pguiRes	= nullptr;	// Assume not found.

			// First check this item . . .
         if ((void*)m_lId != (void*)lId)
				{
				// Check children.
		...
		int16_t IsAncestor(		// Returns TRUE if pgui is an ancestor of this item.
			...
			RGuiItem*	pguiParent =	GetParent();
			while (pguiParent != nullptr && sRes == FALSE)
				{
				if (pguiParent == pgui)
					{
...
//////////////////////////////////////////////////////////////////////////////
	...
	public:	// Member variables.
		...
		// Space that can be used in any way by the user but is intended to represent a user instance structure such as a struct or class.
      Variant m_ulUserInstance;

		// Space that can be used in any way by the user and has no particular intended use.
      Variant m_ulUserData;
      ...
      Variant					m_lId;				// ID.  Used to identify this RGuiItem
	...
	public:
		...
		static RGuiItem*	ms_pguiFocus;		// Higher level APIs can use this as
														...
														// focus.
		static char const *		ms_apszTypes[NumGuiTypes];	// Array of strings 
																	// indexed by type.
	};
