...
//////////////////////////////////////////////////////////////////////////////
int16_t RMultiBtn::SetState(	// Returns 0 on success.
	char const *	pszImageName,		// In:  File name of image for state sState.
	int16_t		sState)			// In:  State to update (0 == feedback state,
									// 1..n == state number).
	{
	int16_t	sRes	= 0;	// Assume success.
...
//////////////////////////////////////////////////////////////////////////////
RImage* RMultiBtn::GetState(	// Returns image, if available; nullptr, otherwise.
