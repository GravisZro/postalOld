...
//--------------- CONSTRUCTION -------------
	...
	void init(char const * const pszFileName, char const * const pszSeparators = " \t,", char const * const pszSpecialCharacters=nullptr, char const cString = '"', char const cComment = '*', short sCharEOL = 1, short sLowFilter = 32, short sHighFilter = 128)
		{
		clear();
	...
	void configure(char const * const pszSeparators = " \t,", char const * const pszSpecialCharacters = nullptr, char const cString = '"', char const cComment = '*', short const sCharEOL = 1, short sLowFilter = 32, short sHighFilter=128)
		{
		m_sCharEOL = sCharEOL;
		m_sLowFilter = sLowFilter;
		m_sHighFilter = sHighFilter;
	...
	RBatch(char const * const pszFileName, char const * const pszSeparators = " \t,", char const * const pszSpecialCharacters = nullptr, char const cString = '"', char const cComment = '*', short const sCharEOL = 1, short sLowFilter=32, short sHighFilter = 128)
		{
