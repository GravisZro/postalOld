...
short CRamFlx::ReadHeader(CNFile* pfile)
	...
	if ((m_pucFlxBuf = (UCHAR*)malloc(lSizeFile)))
		{
...
short CRamFlx::CreateFramePointers(void)
	...
	if ((m_plFrames = (long*)malloc((m_filehdr.sNumFrames+1) * sizeof(long))) == nullptr)
		sError = -1;
	else
		{
