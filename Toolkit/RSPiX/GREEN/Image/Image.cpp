...
short RImage::LoadDib(char const * pszFilename)
{
	RFile cf;
...
short RImage::SaveDib(char const * pszFilename)
{
	RFile cf;
	short sReturn = SUCCESS;
...
short RImage::Save(char const * pszFilename) const
{
	RFile cf;
	short sReturn = SUCCESS;
...
short RImage::Load(char const * pszFilename)
{
	RFile cf;
	short sReturn = SUCCESS;
