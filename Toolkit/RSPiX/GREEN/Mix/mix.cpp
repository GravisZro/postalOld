...
//							BlueCall would return nullptr (representing it was done
//							mixing this channel), causing BlueCallStatic to discard
//							the buffer (even though something was mixed in) IF no 
//							other channels returned non-nullptr.  This has been fixed.
...
//
//		09/04/96 MJR	Changed callback from uint32_t to int32_t for size parameter.
//
...
//
//////////////////////////////////////////////////////////////////////////////
int16_t RMix::Start(RMixCall mcUser, Variant ulUser,
