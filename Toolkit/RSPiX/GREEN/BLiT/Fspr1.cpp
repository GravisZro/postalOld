...
//BLIT_PRELOCKED:
	...
	RFracuint16_t frX = {0};
	RFracuint16_t frOldX = {0};
	RFracuint16_t frOldY = {0},frY = {0};

	RFracuint16_t *afrSkipX=nullptr,*afrSkipY=nullptr;
	afrSkipX = rspfruint16_tStrafe256(sDstW,sDenX);
