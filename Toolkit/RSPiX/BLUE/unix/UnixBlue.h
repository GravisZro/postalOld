...
extern void rspScanKeys(
	uint8_t* pucKeys);				// Out: Array of 128 uint8_ts (one per SK code)
...
extern void rspSetPaletteEntries(
	...
	uint8_t const * pucRed,					// In:  Pointer to starting source red value
	uint8_t const * pucGreen,				// In:  Pointer to starting source green value
	uint8_t const * pucBlue,					// In:  Pointer to starting source blue value
