...
extern short rspGetSoundOutMode(				// Returns 0 if successfull, non-zero otherwise
	...
	long* plBitsPerSample,				// Out: Bits per sample or -1 (unless nullptr)
	long* plChannels,					// Out: Channels (mono=1, stereo=2) or -1 (unless nullptr)
	long* plCurBufferTime,				// Out: Current buffer time or -1 (unless nullptr)
	long* plMaxBufferTime)			// Out: Maximum buffer time or -1 (unless nullptr)
{
