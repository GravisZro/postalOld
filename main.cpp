...
int main(int argc, char **argv)
   ...
   RPrefs prefs;
   if (prefs.Open("PrefFileName"_lookup, "rt") == 0)
      {
...
rspSetProfileOutput("profile.out");
            ...
            // Set app name
            rspSetApplicationName("AppName"_lookup);
