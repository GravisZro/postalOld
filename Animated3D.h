...
class CAnim3D
   ...
   public:  // Methods for this animation.
      ...
      int16_t Get(                    // Returns 0 on success.
         char const * const * ppszFileNames);   // Pointer to array of pointers to filenames.
      ...
      int16_t Get(                          // Returns 0 on success.
         ...
         char const * pszEventName,       // In:  String to add for event states channel,
                                          // "", or nullptr for none.
         char const * pszWeaponTransName, // In:  String to add for weapon transforms channel,
                                          // "", or nullptr for none.
      ...
      virtual                          // If you override this function,
                                       // call base class for default functionality.
      int16_t Get(                       // Returns 0 on success.
         char const * pszBaseName,        // In:  Base string for resource filenames.
         char const * pszVerb,               // In:  Action name to be appended to the base
         char const * pszRigidName,       // In:  String to add for rigid transform channel,
                                       // "", or nullptr for none.
         char const * pszEventName,       // In:  String to add for event states channel,
                                       // "", or nullptr for none.
