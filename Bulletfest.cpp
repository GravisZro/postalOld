...
bool GetTerrainAngle(         // true, if terrain angle determined.
   ...
   int16_t* psAngle)            // Out: Angle of terrain at specified location
                              // on X/Z plane.
   {
  (void)sMaxOutIterations;
  (void)sNumScanIterations;
  (void)sInAngle;
...
#define TRACER_ACCUMMULATION_STEP_MIN  10
         ...
         int16_t sRand    = 0;
// Method 1:  Random dist between here and there.
#if METHOD == 1
...
// Method 2:  Cummulating position with wrapping.
#elif METHOD == 2
...
// Method 3:  Multiple Method 1 and Method 2's.
#elif METHOD == 3
