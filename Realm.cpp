...
#define SET(ptr, val)   ( (ptr) ? *ptr = val : val)
...
char const * CRealm::ms_apszLayerNames[TotalLayers]   =
   {
   "Background",
...
// checkbox form).
char const *   CRealm::ms_apsz2dResPaths[Num2dPaths]  =
   {
   "2d/Top/",
   "2d/Side/",
   "2d/SideBright/",
...
const char* CRealm::Make2dResPath(  // Returns a ptr to an internal static buffer
   ...
   // Get resource path.
   char const *   pszPath  = ms_apsz2dResPaths[m_s2dResPathIndex];
