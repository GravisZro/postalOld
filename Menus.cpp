...
//
//    04/25/97 JMI   StartSingleMenu() was not calling Play_SetRealmName(nullptr)
...
//
//    10/13/97 JMI   Moved "ControlsMenu_UseJoystick"_lookup to localize.* and took
//                   out 'TEMP' comments.
...
static char const *        ms_apszDifficultyDescriptions[]  =
   {
   "Easy",
   "Easy",
   "Easy",
...
Menu  menuMain =
   ...
   // Menu items.
      ...
      {  // pszText,                sEnabled,   pmenu,            pgui
         { "StartMultiplayerMenu_Join"_lookup,TRUE, &menuJoinMulti,   nullptr,    },
         { "MainMenu_Options"_lookup,   TRUE,       &menuOptions,     nullptr,    },
         { "MainMenu_Exit"_lookup,      TRUE,       &menuVerifyExit,  nullptr,    },
         nullptr                    // Terminates list.
      },
#else
      {  // pszText,                sEnabled,   pmenu,            pgui
         { "MainMenu_Start"_lookup,     TRUE,       &menuStartSingle/*menuStart*/,         nullptr,    },
         { "MainMenu_Options"_lookup,   TRUE,       &menuOptions,     nullptr,    },

         #ifndef EDITOR_REMOVED
         { "MainMenu_Editor"_lookup,    TRUE,       nullptr,          nullptr,    },
         #endif

   #if defined(DEMO)
         { "MainMenu_Buy"_lookup,       TRUE,       nullptr,          nullptr,    },
   #endif
         { "MainMenu_Exit"_lookup,      TRUE,       &menuVerifyExit,  nullptr,    },
         nullptr                    // Terminates list.
      },
...
Menu  menuVerifyExit =
   ...
   // Menu items.
      {  // pszText,          sEnabled,   pmenu,      pgui
         { "VerifyExitMenu_Yes"_lookup, TRUE,       nullptr,    nullptr, },
         { "VerifyExitMenu_No"_lookup,  TRUE,       &menuMain,  nullptr, },
         nullptr                    // Terminates list.
      },
   };
...
Menu g_menuVerifyQuitGame =
   ...
   // Menu items.
      {  // pszText,                sEnabled,   pmenu,      pgui
         { "VerifyQuitMenu_Yes"_lookup, TRUE,       nullptr,    nullptr, },
         { "VerifyQuitMenu_No"_lookup,  TRUE,       nullptr,    nullptr, },
         nullptr                    // Terminates list.
      },
   };
...
Menu  menuClientGame =
   ...
   // Menu items.
      {  // pszText,    sEnabled,   pmenu,                  pgui
         { "GameMenu_Continue"_lookup,  TRUE,       nullptr,                nullptr, },
         { "GameMenu_Save"_lookup,      TRUE,       nullptr,                nullptr, },
         { "GameMenu_Options"_lookup,   TRUE,       &menuOptions,           nullptr, },
         { "GameMenu_Quit"_lookup,      TRUE,       nullptr,                nullptr, },
         nullptr                    // Terminates list.
      },
   };
...
Menu  menuEditor =
   ...
   // Menu items.
      {  // pszText,                   sEnabled,   pmenu,               pgui
         { "EditorMenu_Continue"_lookup,   TRUE,       nullptr,             nullptr, },
         { "EditorMenu_Options"_lookup,    TRUE,       &menuOptions,        nullptr, },
         { "EditorMenu_Quit"_lookup,       TRUE,       nullptr,             nullptr, },
         nullptr                    // Terminates list.
      },
   };
...
Menu  menuOptions =
   ...
   // Menu items.
      {  // pszText,                      sEnabled,   pmenu,               pgui
#if 0
         { "OptionsMenu_Video"_lookup,        TRUE,       &menuVideoOptions,   nullptr,},
#endif
         { "OptionsMenu_Audio"_lookup,        TRUE,       &menuAudioOptions,   nullptr,},
         { "OptionsMenu_Controls"_lookup,     TRUE,       &menuControls,       nullptr,},
            #ifndef MULTIPLAYER_REMOVED
         { "OptionsMenu_Multiplayer"_lookup,  TRUE,       &menuMultiOptions,   nullptr,},
            #endif
         { "OptionsMenu_Performance"_lookup,  TRUE,       &menuFeatures,       nullptr,},
         { "OptionsMenu_Difficulty"_lookup,   TRUE,       &menuPlayOptions,    nullptr,},
         { "OptionsMenu_Crosshair"_lookup, TRUE,       nullptr, nullptr,},
...
Menu  menuPlayOptions =
   ...
   // Menu items.
      {  // pszText,                            sEnabled,   pmenu,               pgui
         { "DifficultyMenu_SetDifficulty"_lookup,   TRUE,       nullptr,             nullptr,       },
         { "",                                  FALSE,      nullptr,             nullptr,       },
         nullptr                    // Terminates list.
      },
   };
...
Menu menuOrgan =
   ...
   // Menu items.
      {  // pszText,                               sEnabled,   pmenu,   pgui
         { "",                                     FALSE,      nullptr, nullptr,       },
         { "OrganMenu_SpecialKeysHeading"_lookup,      FALSE,      nullptr, nullptr,       },
         { "OrganMenu_NumericKeysFunction"_lookup,     FALSE,      nullptr, nullptr,       },
         { "OrganMenu_AlphaKeysFunction"_lookup,       FALSE,      nullptr, nullptr,       },
         { "OrganMenu_TabKeyFunction"_lookup,          FALSE,      nullptr, nullptr,       },
         { "",                                     FALSE,      nullptr, nullptr,       },
         { "OrganMenu_Exit"_lookup,                    TRUE,       nullptr, nullptr,       },
         nullptr                    // Terminates list.
      },
   };
...
Menu  menuAudioOptions =
   ...
   // Menu items.
      {  // pszText,          sEnabled,   pmenu,               pgui
         { "AudioMenu_Mixer"_lookup,          TRUE,       &menuVolumes,        nullptr,       },
         { "AudioMenu_SoundTest"_lookup,      TRUE,       &menuOrgan,          nullptr,       },
         { "",                            FALSE,      nullptr,             nullptr,       },
         nullptr                    // Terminates list.
      },
   };
...
Menu  menuVideoOptions =
   ...
   // Menu items.
      {  // pszText,             sEnabled,   pmenu,               pgui
         { "VideoMenu_Gamma"_lookup, TRUE,       nullptr,             nullptr,       },
         { "",                   FALSE,      nullptr,             nullptr,       },
         nullptr                    // Terminates list.
      },
   };
...
Menu  menuControls =
   ...
   // Menu items.
      {  // pszText,                                  sEnabled,   pmenu,               pgui
         { "ControlsMenu_KeyboardSetup"_lookup,           TRUE,       &menuKeyboard,       nullptr,       },
         { "ControlsMenu_MouseSetup"_lookup,              TRUE,       &menuMouse,          nullptr,       },
#if defined(ALLOW_JOYSTICK)
         { "ControlsMenu_JoystickSetup"_lookup,           TRUE,       &menuJoystick,       nullptr,       },
#endif // defined(ALLOW_JOYSTICK)
         { "ControlsMenu_TurningSpeeds"_lookup,           TRUE,       &menuRotation,       nullptr,       },
#if defined(ALLOW_JOYSTICK)
         { "ControlsMenu_UseJoystick"_lookup,             TRUE,       nullptr,             nullptr,       },
#endif // defined(ALLOW_JOYSTICK)
...
Menu  menuKeyboard =
   ...
   // Header and its font info.
      {  // pszHeaderText, pszFontFile, sHeight, u32ForeColor, u32BackColor, u32ShadowColor.
      "KeyboardSetupMenu_Title"_lookup,
      SMASH_FONT,
      HEAD_FONT_HEIGHT, // Height of font.
      HEAD_COLOR,       // Text RGBA.
      HEAD_SHADOW_COLOR // Text Shadow RGBA.
...
Menu  menuJoystick =
   ...
   // Header and its font info.
      {  // pszHeaderText, pszFontFile, sHeight, u32ForeColor, u32BackColor, u32ShadowColor.
      "JoystickSetupMenu_Title"_lookup,
      SMASH_FONT,
      HEAD_FONT_HEIGHT, // Height of font.
      HEAD_COLOR,       // Text RGBA.
      HEAD_SHADOW_COLOR // Text Shadow RGBA.
...
Menu  menuRotation =
   ...
   // Header and its font info.
      {  // pszHeaderText, pszFontFile, sHeight, u32ForeColor, u32BackColor, u32ShadowColor.
      "RotationSetupMenu_Title"_lookup,
      SMASH_FONT,
      HEAD_FONT_HEIGHT, // Height of font.
      HEAD_COLOR,       // Text RGBA.
      HEAD_SHADOW_COLOR // Text Shadow RGBA.
   ...
   // Menu items.
      {  // pszText,                               sEnabled,   pmenu,               pgui
         { "RotationSetupMenu_RunningSlow"_lookup,     TRUE,       nullptr,             nullptr,       },
         { "RotationSetupMenu_RunningFast"_lookup,     TRUE,       nullptr,             nullptr,       },
         { "RotationSetupMenu_StandingSlow"_lookup,    TRUE,       nullptr,             nullptr,       },
         { "RotationSetupMenu_StandingFast"_lookup,    TRUE,       nullptr,             nullptr,       },
         { "RotationSetupMenu_TapDegrees"_lookup,      TRUE,       nullptr,             nullptr,       },
         { "RotationSetupMenu_RestoreDefaults"_lookup, TRUE,       nullptr,             nullptr,       },
         { "",                                     FALSE,      nullptr,             nullptr,       },
         nullptr                    // Terminates list.
      },
   };
...
Menu  menuStart =
   ...
   // Menu items.
      {  // pszText,                               sEnabled,   pmenu,            pgui
         { "StartGameMenu_SinglePlayer"_lookup,        TRUE,       &menuStartSingle, nullptr, },
            #ifndef MULTIPLAYER_REMOVED
         { "StartGameMenu_Multiplayer"_lookup,         TRUE,       &menuStartMulti,  nullptr, },
            #endif
         { "StartGameMenu_Demo"_lookup,                TRUE,       &menuStartDemo,   nullptr, },
         { "",                                     FALSE,      nullptr,          nullptr, },
         nullptr                    // Terminates list.
      },
   };
...
Menu  menuStartSingle =
   ...
   // Header and its font info.
      {  // pszHeaderText, pszFontFile, sHeight, u32ForeColor, u32BackColor, u32ShadowColor.
      "StartSinglePlayerMenu_Title"_lookup,
      SMASH_FONT,
      HEAD_FONT_HEIGHT, // Height of font.
      HEAD_COLOR,       // Text RGBA.
      HEAD_SHADOW_COLOR // Text Shadow RGBA.
   ...
   // Menu items.
      {  // pszText,                               sEnabled,   pmenu,            pgui
         { "StartSinglePlayerMenu_New"_lookup,         TRUE,       nullptr,          nullptr,},
#if defined(START_MENU_ADDON_ITEM)
         { "StartSinglePlayerMenu_AddOn"_lookup,       TRUE,       nullptr,          nullptr,},
#endif
            #ifndef LOADLEVEL_REMOVED
         { "StartSinglePlayerMenu_LoadLevel"_lookup,   TRUE,       nullptr,          nullptr,},
            #endif
         { "StartSinglePlayerMenu_LoadGame"_lookup,    TRUE,       nullptr,          nullptr, },
         { "StartSinglePlayerMenu_Challenge"_lookup,   TRUE,       /*&menuChallenge,*/nullptr,nullptr,},
         { "",                                     FALSE,      nullptr,          nullptr, },
         nullptr                    // Terminates list.
      },
   };
...
Menu  menuChallenge =
   ...
   // Header and its font info.
      {  // pszHeaderText, pszFontFile, sHeight, u32ForeColor, u32BackColor, u32ShadowColor.
      "StartChallengeMenu_Title"_lookup,
      SMASH_FONT,
      HEAD_FONT_HEIGHT, // Height of font.
      HEAD_COLOR,       // Text RGBA.
      HEAD_SHADOW_COLOR // Text Shadow RGBA.
   ...
   // Menu items.
      {  // pszText,             sEnabled,      pmenu,      pgui
         { "StartChallengeMenu_Gauntlet"_lookup,    TRUE,       nullptr,    nullptr, },
         { "StartChallengeMenu_Timed"_lookup,       TRUE,       nullptr,    nullptr, },
         { "StartChallengeMenu_Goal"_lookup,        TRUE,       nullptr,    nullptr, },
         { "StartChallengeMenu_Flag"_lookup,        TRUE,       nullptr,    nullptr, },
         { "StartChallengeMenu_CheckPoint"_lookup,  TRUE,       nullptr,    nullptr, },
         { "",                                  FALSE,      nullptr,    nullptr, },
         nullptr                    // Terminates list.
      },
   };
...
Menu  menuStartMulti =
   ...
   // Header and its font info.
      {  // pszHeaderText, pszFontFile, sHeight, u32ForeColor, u32BackColor, u32ShadowColor.
      "StartMultiplayerMenu_Title"_lookup,
      SMASH_FONT,
      HEAD_FONT_HEIGHT, // Height of font.
      HEAD_COLOR,       // Text RGBA.
      HEAD_SHADOW_COLOR // Text Shadow RGBA.
   ...
   // Menu items.
      {  // pszText,                            sEnabled,   pmenu,               pgui
         { "StartMultiplayerMenu_Join"_lookup,      TRUE,       &menuJoinMulti,      nullptr, },
         { "StartMultiplayerMenu_Host"_lookup,      TRUE,       &menuHostMulti,      nullptr, },
         { "StartMultiplayerMenu_Options"_lookup,   TRUE,       &menuMultiOptions,   nullptr, },
         { "",                                  FALSE,      nullptr,             nullptr, },
         nullptr                    // Terminates list.
      },
   };
...
Menu  menuJoinMulti =
   ...
   // Menu items.
      {  // pszText,                      sEnabled,   pmenu,               pgui
         { "JoinGameMenu_Browse"_lookup,      TRUE,       nullptr,             nullptr, },
         { "JoinGameMenu_ConnectTo"_lookup,   TRUE,       nullptr,             nullptr,},
         { "",                            FALSE,      nullptr,             nullptr, },
         nullptr                    // Terminates list.
      },
   };
...
Menu  menuHostMulti =
   ...
   // Menu items.
      {  // pszText,                sEnabled,   pmenu,               pgui
         { "HostGameMenu_Start"_lookup, TRUE,       nullptr,             nullptr, },
         { "",                      FALSE,      nullptr,             nullptr, },
         nullptr                    // Terminates list.
      },
   };
...
Menu  menuStartDemo =
   ...
   // Menu items.
      {  // pszText,                   sEnabled,   pmenu,      pgui
//       { "StartDemoMenu_Browse"_lookup,  TRUE,       nullptr,    nullptr, },
         { "StartDemoMenu_Play"_lookup,    TRUE,       nullptr,    nullptr, },
         { "StartDemoMenu_Record"_lookup,  TRUE,       nullptr,    nullptr, },
         { "",                         FALSE,      nullptr,    nullptr, },
         nullptr                    // Terminates list.
      },
   };
...
Menu  menuMultiOptions =
   ...
   // Header and its font info.
      {  // pszHeaderText, pszFontFile, sHeight, u32ForeColor, u32BackColor, u32ShadowColor.
      "MultiplayerSetupMenu_Title"_lookup,
      SMASH_FONT,
      HEAD_FONT_HEIGHT, // Height of font.
      HEAD_COLOR,       // Text RGBA.
      HEAD_SHADOW_COLOR // Text Shadow RGBA.
   ...
   // Menu items.
      {  // pszText,          sEnabled,   pmenu,         pgui
         { "MultiplayerSetupMenu_Name"_lookup,         TRUE,       nullptr,       nullptr, },
         { "MultiplayerSetupMenu_Color"_lookup,        TRUE,       nullptr,       nullptr, },
         { "MultiplayerSetupMenu_Protocol"_lookup,     TRUE,       nullptr,       nullptr, },
         { "MultiplayerSetupMenu_Connection"_lookup,   TRUE,       nullptr,       nullptr, },
         { "",                                     FALSE,      nullptr,       nullptr, },
         nullptr                    // Terminates list.
      },
   };
...
int16_t SetUpRotationScrollBar(    // Returns 0 on success.
   ...
   char const *      pszResName)          // In:  Resource name.
   {
   int16_t sRes  = 0;  // Assume success.
