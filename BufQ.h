...
class CBufQ
   ...
   public:
      ...
      int32_t Put(            // Returns number of items that were put into queue
         ...
         int32_t lNum = 1)    // In:  Number of uint16_ts to put.
         {
         int32_t  lNumPut  = -1;
      ...
      int32_t Put(            // Returns number of items that were put into queue
         ...
         int32_t lNum = 1)    // In:  Number of int16_ts to put.
         {
      ...
      int32_t Put(            // Returns number of items that were put into queue
         ...
         int32_t lNum = 1)    // In:  Number of uint32_ts to put.
         {
         int32_t  lNumPut  = -1;
      ...
      int32_t Put(            // Returns number of items that were put into queue
         ...
         int32_t lNum = 1)    // In:  Number of int32_ts to put.
         {
      ...
      int32_t Get(            // Returns number of items dequeued.
         ...
         int32_t lNum = 1)    // In:  Number of uint16_ts to get.
         {
         int32_t  lNumGot  = -1;
         uint8_t*   pu8Buf   = (uint8_t*)pu16Buf;
      ...
      int32_t Get(            // Returns number of items dequeued.
         ...
         int32_t lNum = 1)    // In:  Number of int16_ts to get.
         {
      ...
      int32_t Get(            // Returns number of items dequeued.
         ...
         int32_t lNum = 1)    // In:  Number of uint32_ts to get.
         {
         int32_t  lNumGot  = -1;
         uint8_t*   pu8Buf   = (uint8_t*)pu32Buf;
      ...
      int32_t Get(            // Returns number of items dequeued.
         ...
         int32_t lNum = 1)    // In:  Number of int32_ts to get.
         {
