...
struct Personatorium {
   ...
   public:
      ...
      char const *   pszDescription;      // Example: "Gunner Gal", as in "Place a GUNNER GAL".

      // Animation strings for this person.
      struct
         {
         // Names used to create animation resource filenames.
         char const *  pszBaseName;    // Example: "Gunner", as in "3d/GUNNER_shoot.sop".
         int16_t sTextureScheme;   // Example: 0 would make "3d/GUNNER0.tex"
         char const *   pszObjectName;    // Name of channels of transforms for ammo.
                                 // Example: "Bullet", as in "3d/gunner_shoot_BULLET.trans".
         char const *   pszHandName;      // Name of channels of transforms for hand.
                                 // Example: "hand", as in "3d/gunner_shoot_HAND.trans"
         char const *   pszEventName;     // Example: "main", as in "3d/gunner_shoot_MAIN.event".
         } Anim;
...
// a CPerson.
extern Personatorium const g_apersons[Personatorium::NumPersons];
