...
class CLogTabVar
   ...
   protected:
      ...
      char const *  m_pszName;                                 // Variable name
      ...
      char const * * m_papszStrings;                           // Pointer to array of pointers to strings
   ...
   public:
      ...
      int16_t FindVar(                                  // Returns 0 if successfull, non-zero otherwise
         char const *  pszName,                                // In:  Variable name to find
      ...
      int16_t TextToVal(                                // Returns 0 if successfull, non-zero otherwise
         char const *  pszText,                                // In:  Text to convert
      ...
      // Get name
      ////////////////////////////////////////////////////////////////////////////////
      char const *  GetName(void)                              // Returns name
         {
         return m_pszName;
         }
