...
//                   once in a while (the timeout timer was too int16_t).
//
...
//
//    09/09/97 JMI   Now initializes ms_pguiRetry to nullptr in DlgBeGone().
//
...
char const * const  "ClientStat_Connected"_lookup               = "Connected";
char const * const  "ClientStat_JoinDenyTooMany"_lookup         = "Can't join -- too many players";
char const * const  "ClientStat_JoinDenyLowBandwidth"_lookup = "Can't join -- your bandwidth is too low";
char const * const  "ClientStat_JoinDenyCantDropIn"_lookup      = "Can't join -- game has already started";
char const * const  "ClientStat_JoinDenyUnknown"_lookup         = "Can't join -- don't know why";
char const * const  "ClientStat_JoinAccepted"_lookup            = "Joined";
...
char const * const  "ServerStat_AcceptedClient"_lookup       = "\"%s\" has joined";
char const * const  "ServerStat_CantAcceptJoinReq"_lookup    = "Can't grant join request (too many players)";
char const * const  "ServerStat_InvalidChangeReq_hd"_lookup     = "Ignored invalid change request (ID = %hd)";
char const * const  "ServerStat_LoginAccepted_hd"_lookup        = "Login accepted (id = %hd)";
char const * const  "ServerStat_LoginDeniedVersion_ld"_lookup   = "Login denied (obsolete client version %ld)";
char const * const  "ServerStat_LoginDeniedMagic"_lookup        = "Login denied (invalid signature)";
char const * const  "ServerStat_Startup"_lookup                 = "Setting up connection...";
char const * const  "ServerStat_Default"_lookup                 = "Ready";
char const * const  "ServerStat_CantDropSelf"_lookup            = "You can't drop yourself";
char const * const  "ServerStat_PlayerErr"_lookup               = "Player was dropped (bad connection)";
...
char const * const  "NetStat_ReceiveError"_lookup               = "Network error (can't receive data)";
char const * const  "NetStat_InQFullError"_lookup               = "Network error (input buffer is full)";
char const * const  "NetStat_OutQFullError"_lookup              = "Network error (output buffer is full)";
char const * const  "NetStat_SendError"_lookup                  = "Network error (can't send data)";
char const * const  "NetStat_InQReadError"_lookup               = "Network error (can't read data)";
char const * const  "NetStat_OutQWriteError"_lookup          = "Network error (couldn't write data)";
char const * const  "NetStat_ConnectionError"_lookup            = "Network error (bad connection)";
char const * const  "NetStat_TimeoutError"_lookup               = "Network error (time-out)";
char const * const  "NetStat_ListenError"_lookup             = "Network error (can't listen)";
char const * const  "NetStat_ConnectError"_lookup               = "Network error (can't connect)";
char const * const  "NetStat_ConnectTimeoutError"_lookup        = "Network error (connection attempt timed-out)";
char const * const  "NetStat_ClientVersionMismatchError_lu_lu"_lookup = "Version mismatch--dropping (Host ver is %lu -- Our ver is %lu)";
char const * const  "NetStat_ServerVersionMismatchError_lu_lu"_lookup = "Version mismatch--dropping client (Client ver is %lu -- Our ver is %lu)";
char const * const  "NetStat_CantOpenPeerSocketError"_lookup = "Network error (couldn't connect to other players)";
char const * const  "NetStat_LoginDeniedError"_lookup           = "Login failed";
char const * const  "NetStat_JoinDeniedError"_lookup            = "Host refused join request";
char const * const  "NetStat_UnknownError"_lookup               = "Network error (general failure)";
char const * const  "NetStat_ProgramError"_lookup               = "Network error (generic failure)";
#if defined(WIN32)
   char const * const  "NetStat_ClientPlatformMismatchError"_lookup   = "Cannot login to host because it is a Mac";
   char const * const  "NetStat_ServerPlatformMismatchError"_lookup   = "Cannot allow client to connect because it is a Mac";
#else
   char const * const  "NetStat_ClientPlatformMismatchError"_lookup   = "Cannot login to host because it is a PC";
   char const * const  "NetStat_ServerPlatformMismatchError"_lookup   = "Cannot allow client to connect because it is a PC";
#endif
...
char const * const  "NetDlg_ConnectedPlayers_d"_lookup       = "Connected Players: %d";

// Text which is used for the net problems GUI.
// WARNING: This is an EXTERN and is used by other modules!
char const * const   "NetProb_General"_lookup =
...
static void CleanClientDlg(
   ...
   RSP_SAFE_GUI_REF_VOID(pguiConnected, SetText("NetDlg_ConnectedPlayers_d"_lookup, iNumPlayers));
...
static int16_t SetupDlg(     // Returns 0 on success.
   char const * const   pszGuiFile,       // In:  Full path to GUI file.
...
int16_t DlgGetRes(                                // Returns 0 if successfull, non-zero otherwise
   ...
   if (rspGetResource(&g_resmgrShell, szFile, &pgui->m_pimBkdRes) == 0)
      {
      // Set palette
      ASSERT(pgui->m_pimBkdRes->m_pPalette);
...
static void AddConsoleMsg( // Returns nothing.
   ...
   if (ms_plbNetConsole)
      ...
      if (bChat)
         ...
         sprintf(szMsg, "%s%s", "NetStatusMsgPrefix"_lookup, szOutput);
...
extern const char* NetErrorText(                // Returns pointer to text
   ...
   {
   char const * pText = "";
   bool handled = true; // assume handled in first switch
   ...
   case NetMsg::NoError:
      pText = "NetStat_NoError"_lookup;
      break;
   case NetMsg::ReceiveError:
      pText = "NetStat_ReceiveError"_lookup;
      break;
   case NetMsg::InQFullError:
      pText = "NetStat_InQFullError"_lookup;
      break;
   case NetMsg::OutQFullError:
      pText = "NetStat_OutQFullError"_lookup;
      break;
   case NetMsg::SendError:
      pText = "NetStat_SendError"_lookup;
      break;
   case NetMsg::InQReadError:
      pText = "NetStat_InQReadError"_lookup;
      break;
   case NetMsg::OutQWriteError:
      pText = "NetStat_OutQWriteError"_lookup;
      break;
   case NetMsg::ConnectionError:
      pText = "NetStat_ConnectionError"_lookup;
      break;
   case NetMsg::TimeoutError:
      pText = "NetStat_TimeoutError"_lookup;
      break;
   case NetMsg::ListenError:
      pText = "NetStat_ListenError"_lookup;
      break;
   case NetMsg::CantConnectError:
      pText = "NetStat_ConnectError"_lookup;
      break;
   case NetMsg::ConnectTimeoutError:
      pText = "NetStat_ConnectTimeoutError"_lookup;
      break;
   case NetMsg::LoginDeniedError:
      pText = "NetStat_LoginDeniedError"_lookup;
      break;
   case NetMsg::JoinDeniedError:
   pText = "NetStat_JoinDeniedError"_lookup;
   break;
   case NetMsg::CantOpenPeerSocketError:
   pText = "NetStat_CantOpenPeerSocketError"_lookup;
   break;
   case NetMsg::ServerPlatformMismatchError:
   pText = "NetStat_ServerPlatformMismatchError"_lookup;
   break;
   case NetMsg::ClientPlatformMismatchError:
   pText = "NetStat_ClientPlatformMismatchError"_lookup;
   break;
   ...
   case NetMsg::ServerVersionMismatchError:
      snprintf(szStaticErrorText, sizeof(szStaticErrorText), "NetStat_ServerVersionMismatchError_lu_lu"_lookup, pmsg->msg.err.ulParam, CNetMsgr::CurVersionNum & ~CNetMsgr::MacVersionBit);
      break;
   case NetMsg::ClientVersionMismatchError:
      snprintf(szStaticErrorText, sizeof(szStaticErrorText), "NetStat_ClientVersionMismatchError_lu_lu"_lookup, pmsg->msg.err.ulParam, CNetMsgr::CurVersionNum & ~CNetMsgr::MacVersionBit);
      break;

   default:
      return "NetStat_UnknownError"_lookup;
   }

   return szStaticErrorText;
}
...
static int16_t GetRealmFileFromRealmTitle(  // Returns 0, if found; non-zero
   ...
   char const * const   pszRealmTitle,                   // In:  Realm title.
...
static void OnDroppedMsg(
   ...
   RGuiItem*   pguiConnected  = ms_pguiRoot->GetItemFromId(GUI_ID_PLAYERS_STATIC1);
   RSP_SAFE_GUI_REF_VOID(pguiConnected, SetText("NetDlg_ConnectedPlayers_d"_lookup, pnet->GetNumPlayers()));
   RSP_SAFE_GUI_REF_VOID(pguiConnected, Compose());
   pguiConnected  = ms_pguiRoot->GetItemFromId(GUI_ID_PLAYERS_STATIC2);
   RSP_SAFE_GUI_REF_VOID(pguiConnected, SetText("NetDlg_ConnectedPlayers_d"_lookup, pnet->GetNumPlayers()));
   RSP_SAFE_GUI_REF_VOID(pguiConnected, Compose());
      ...
      if (sResult == 0)
         ...
         if (sResult == 0)
            ...
            if (sResult == 0)
               ...
               if (pserver)
                  AddConsoleMsg(false, "%s", "ServerStat_Startup"_lookup);
               else
                  AddConsoleMsg(false, "ClientStat_Startup"_lookup);
                           ...
                           switch (action)
                              ...
                              case DLG_OK:
                                 ...
                                 if (pserver)
                                    ...
                                    if (!bStart && !bAbort && pserver->GetNumberOfClients())
                                       ...
                                       AddConsoleMsg(false, "%s", "NetStat_Starting"_lookup);
                              ...
                              case DLG_CANCEL:
                                 ...
                                 if (bAbort)
                                    ...
                                    // Feedback
                                    AddConsoleMsg(false, "%s", "NetStat_Aborting"_lookup);
                                    PlaySample(g_smidMenuItemSelect, SampleMaster::UserFeedBack);
                                 ...
                                 if (!bStart && !bAbort)
                                    ...
                                    if (pguiPlayerSel)
                                       ...
                                       if (id == pclient->GetID())
                                          ...
                                          AddConsoleMsg(false, "%s", "ServerStat_CantDropSelf"_lookup);
                                          }
                                       else
                                          {
                              ...
                              case DLG_RETRY:
                                 if (!bStart && !bAbort)
                                    ...
                                    // Feedback
                                    PlaySample(g_smidMenuItemSelect, SampleMaster::UserFeedBack);
                                    AddConsoleMsg(false, "%s", "ClientStat_Retrying"_lookup);
                                    AddConsoleMsg(false, "ClientStat_Startup"_lookup);
                                 ...
                                 switch(msg.msg.nothing.ucType)
                                    ...
                                    case NetMsg::ERR:
                                       if (msg.ucSenderID == Net::InvalidID)
                                          ...
                                          AddConsoleMsg(false, "ServerStat_PlayerErr"_lookup);
                                          }
                                       break;
                                 ...
                                 switch(msg.msg.nothing.ucType)
                                    ...
                                    case NetMsg::STAT:
                                       switch (msg.msg.stat.status)
                                          {
                                          case NetMsg::Opened:
                                             AddConsoleMsg(false, "%s", "ClientStat_Opened"_lookup);
                                             break;

                                          case NetMsg::Connected:
                                             AddConsoleMsg(false, "%s", "ClientStat_Connected"_lookup);
                                             break;
                                          ...
                                          case NetMsg::LoginAccepted:
                                             ...
                                             AddConsoleMsg(false, "ClientStat_LoginAccepted_hd"_lookup, (int16_t)pclient->GetID());
                                             break;

                                          case NetMsg::JoinAccepted:
                                             AddConsoleMsg(false, "%s", "ClientStat_JoinAccepted"_lookup);
                                             break;
                                    ...
                                    case NetMsg::JOINED:
                                       if (OnJoinedMsg(pclient, &msg, pserver ? true : false) != 0)
                                          ...
                                          AddConsoleMsg(false, "NetStat_ProgramError"_lookup);
                                    ...
                                    case NetMsg::ABORT_GAME:
                                       AddConsoleMsg(false, "%s", "ClientStat_ServerAborted"_lookup);
                                    ...
                                    default:
                                       AddConsoleMsg(false, "%s", "NetStat_UnhandledMsg"_lookup);
                                       break;
                                    }
                                 }
                              }
...
static int16_t NetBlockingCallback(void)          // Returns 0 to continue normally, 1 to abort
   ...
   if (m_bNetWatchdogExpired)
      ...
      if (ptxt)
         ...
         ptxt->SetText("%s", "NetProb_General"_lookup);
         ptxt->Compose();
...
extern int16_t InitNetProbGUI(void)
   ...
   if (sRes == 0)
      ...
      ms_ptxtNetProb->SetText("%s", "NetProb_General"_lookup);
